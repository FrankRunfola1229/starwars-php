 ...
 <div class="container my-5 py-2">
        <div class="flex-container ">
            ...
            <h2 id="title">Star Wars API</h2>

            <!-- ***************** GEARS ********************-->
            <div id="gearsContainer">
                <div id="gearsContainer1" class="row">
                    <div id="loadingGears" class="col-lg-2  my-2">
                        <div class="gear one">
        ...
        <div class="table-responsive-md  my-3 ">
            <table class="table table-striped table-dark">
                <thead>
                    <tr>
                        <!-- ***************** TOTAL ********************-->
                        <th id="total" scope="col" colspan="3"> Total=0 </th>
                    </tr>
                    <tr>
                        <th id="count" scope="col"> # </th>
                        <th id="planetName" scope="col">Planet Name</th>
                        <th id="population" scope="col">Population</th>
                    </tr>
                </thead>
                <tbody>
                    <!--******************************************-->
                    <!--*****POPULATE TABLE WITH JAVASCRIPT*******-->
                    <!--******************************************-->
                <tbody>
            </table>
        </div>
